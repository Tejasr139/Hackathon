...
//    }
    ...
    @GetMapping("/requests")
    public List<ConnectionRequest> getPendingRequestsForMentor(@RequestParam String mentorEmail) {
        return connectionRequestService.getPendingRequestsByMentorEmail(mentorEmail);
    }
